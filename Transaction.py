...
class Transaction():
    def __init__(self,sender_address,inputs,outputs,private_key,t_type = None,hash_type='SHA256'):
        ...
        self.idx = generate_hash(str(self),type=hash_type)
        self.t_type = t_type
...
class Output():
    def __init__(self,to_address,amount,hash_type='SHA256'): ###to_address is hexadecimal
